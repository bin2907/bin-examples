...
public class CompoundDemo {
	public static void main( String[] args )
    {
        ...
        Configuration configuration = new Configuration().configure(CompoundDemo.class.getResource("/hibernate.compoundkey.cfg.xml"));
        ...
        try{
        	...
        	// Demo with id the same => error
        	/*User u2 = (User) session.load(User.class, 1);
        	Role r2 = (Role) session.load(Role.class, 1);
