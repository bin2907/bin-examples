...

{
   Cfg: { 
      ...
      PrintPagePrefix:"<center style='width:%7px'>Page %1H / %4 , %2V / %5</center>", 
      PrintPagePostfix:"<center style='width:%7px'>Printed page %3 / %6</center>",  // Sample page header and footer
      PrintPaddingHeight:"60", PrintPaddingWidth:"36", // Reserved space for PrintPagePrefix / Postfix a nad for default body margin and padding
   ...
   Def: [
      ...
      { Name:"Group", 
         Calculated:"1", CalcOrder:"N2HtmlPostfix,S,E,U,C,F,G,P,O", // Grouping row is calculated to show summary for its children
         ...
         OFormula:"ganttprogressline(Grid.Rows.Project.Progress,0,0)",
   ...
   Cols: [
      ...
      { Name:"O", Visible:"0", Width:"100", Formula:"ganttprogressline(Grid.Rows.Project.Progress)" }, // Hidden column to calculate progress line as GanttMark
   ...
   RightCols: [
      ...
      {  Name:"G",  
         ...
         GanttMark:"O", // Defines source column for progress line
   ...
   Pagers: [
      ...
      { Name:"Month", Caption:"Month", Type:"Gantt", PageSize:"M", ChartSize:"y", Left:"1", Format:"MMM", Width:"50", ZoomToPage:"5" },
   ...
   Solid: [
      ...
      {
         Kind:"Group", id:"Group", Space:"0", Panel:"0", Cells:"List,Zoom,Ex,HidEx,Cal", CanPrint:"5",
         ...
         CalType:"Bool", CalNoColor:"1", CalLeft:"5", CalCanFocus:"0", CalCanEdit:"1", CalPrintHPage:"2",
      ...
      {
         Kind:"Topbar2", id:"Project", Space:"0", Panel:"0", Cells:"Base,Finish,Crit,Dep,Progress", CanPrint:"5",
         ...
         CritType:"Bool", CritNoColor:"1", CritCanEdit:"1", CritLeft:"2", CritCanFocus:"0", CritPrintHPage:"2",
         ...
         DepDefaults:"|Ignore problems|Auto correct problems|Confirm problems",
         ...
         ProgressOnChange:"Grid.Calculate(1)",
      ...
      {
         Kind:"Toolbar1", Space:"4", Cells:"Resources,Use,Avail,Free,Err,Empty,Dep", Panel:"0", CanPrint:"5",
         ...
         UseType:"Bool", UseNoColor:"1", UseCanEdit:"1", UseLeft:"5", UseCanFocus:"0", UsePrintHPage:"2",
         ...
         UseTip:"Shows resources usage chart",

         AvailType:"Bool", AvailNoColor:"1", AvailCanEdit:"1", AvailLeft:"5", AvailCanFocus:"0", AvailPrintHPage:"2",
         ...
         AvailTip:"Shows resource availability chart",

         FreeType:"Bool", FreeNoColor:"1", FreeCanEdit:"1", FreeLeft:"5", FreeCanFocus:"0", FreePrintHPage:"2",
         ...
         FreeTip:"Shows chart with free resources (available - used)",

         ErrType:"Bool", ErrNoColor:"1", ErrCanEdit:"1", ErrCanFocus:"0", ErrLeft:"5", ErrPrintHPage:"2",
         ...
         ErrTip:"Shows chart with resource errors (where usage is higher than availability)",
          
         EmptyRelWidth:"1", EmptyType:"Html", EmptyPrintHPage:"1",
         DepFormula:"ganttdependencyerrors(null,1)", DepOnClick:"CorrectAllDependencies", DepTip:"Click to correct the dependencies", DepPrintHPage:"1"
         }                  
      ],
