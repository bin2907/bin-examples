...

{
   Cfg : {
      ...
      FilterEmpty:1,              // Parent rows without visible children are hidden
   ...
   Solid : [
      ...
      { 
         Kind:"Group", Space:1, Panel:1, id:'Group', CanFocus:0, Cells:'List,Custom,Month,Cust',
      ...
      // --- Search settings ---
      { 
         Kind:"Search", Space:1, Panel:1, id:'Search', NoColor:1, CanFocus:0,
