...
Cfg : {
   ...
   Dragging:"1", Dropping:"1", ShowDrag:"1", DragObject:"1", ExpandOnDrag:"1", ScrollOnDrag:"50", ScrollColOnDrag:"100", NoScrollAfterExpand:"1",
   ScrollOnButton:"20", ScrollOnBody:"200", ScrollColOnButton:"10", ScrollColOnBody:"100", TouchScroll:"2",
...
Actions : {
   ...
   OnDrag1Row:"0", OnDrag2Row:"0", OnDrag3Row:"DragRow",
   OnDrag2Grid:"0",
   ...
   EdgeSize:"5", GanttSize:"5", DragSize:"5", ClickSize:"5", GridSize:"20", GanttSizeOver:"0",
   EdgeSizeTouch:"20", GanttSizeTouch:"1000", DragSizeTouch:"5", ClickSizeTouch:"20", GridSizeTouch:"40", GanttSizeOverTouch:"0"
   },
...
DefCols: {
   ...
   Gantt: { 
      ...
      GanttOrder:"Chart,Availability,Constraints,Run,Main,Flow,Mark,Dependency,Format,Flags,Points", GanttObject:"Main", GanttFormatObject:"Last", GanttFormat:"*GanttResources*", GanttFlowJoin:"1", GanttResizeBeforeMove:"2",
      GanttSize:"", GanttWidth:"18", GanttUnits:"d", GanttLeft:"0", GanttRight:"0", MaxWidth:"10000", GanttRoundUnits:"0",
      GanttDataUnits:"d", GanttLastUnit:"", GanttResourcesAssign:"4", GanttPointsShift:"3", GanttAvailabilityFormat:"0.##",
      GanttHover:"1", GanttEdit:"All", GanttResizeDelete:"1", GanttUseConstraints:"2", GanttShowConstraints:"1",
      GanttSmoothZoom:"1", GanttHideExclude:"0", GanttChangeExclude:"0", GanttMaxExclude:"10000000", GanttBase:"", GanttBaseCanEdit:"2", GanttFinish:"", GanttFinishCanEdit:"1",
      GanttCheck:"4", GanttCheckTime:"1000", GanttCheckExclude:"1", GanttStrict:"1", GanttBasePreferred:"0", GanttFinishPreferred:"0", GanttEditStartMove:"1", GanttMinSlack:"0", GanttErrSlack:"0", GanttSeparateSlack:"0", GanttShowBounds:"1",
      GanttCheckDependencies:"2", GanttCorrectDependencies:"2", GanttIncorrectDependencies:"1", GanttCorrectDependenciesFixed:"0", GanttAllDependencies:"2", GanttFixComplete:"0", GanttMaxCorrectingLoops:"40",
      GanttRunResize:"Resize", GanttRunMove:"Slide", GanttRunAdjust:"Shift", GanttRunAdjustStart:"Slip", GanttRunAdjustCorrect:"Slip", GanttRunError:"Sort",
      GanttRunNew:"0.0001,Box", GanttRunNewStart:"0.0001,Box", GanttRunGroupHover:"1", GanttRunStates:"1", GanttRunCorrectFixed:"0", GanttRunMilestones:"1",
...
Toolbar : {
   ...
   OutdentOnEnter:"OutdentF", OutdentVisibleFormula:"!!Grid.MainCol && !!Grid.Dragging",
   IndentOnEnter:"IndentF", IndentVisibleFormula:"!!Grid.MainCol && !!Grid.Dragging",
